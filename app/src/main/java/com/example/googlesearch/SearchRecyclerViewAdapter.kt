...
class SearchRecyclerViewAdapter(private val items: MutableList<SearchModel>, val context: SearchActivity): RecyclerView.Adapter<SearchRecyclerViewAdapter.ViewHolder>() {
